	...
	<div id="primary--page-main" class="content-area--page-main">
        ...
        <section class="page-foyer">
          ...
          <div class="floor" id="firstFloor">
            <svg xmlns="http://www.w3.org/2000/svg" class="svgFloor1" id="elevator" style="z-index: 2;" viewBox="0 0 1922 1082">
              <g id="Group_518" data-name="Group 518" transform="translate(1 1)">
